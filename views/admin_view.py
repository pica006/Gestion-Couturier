...
def afficher_vue_360(couturier_model: CouturierModel, charges_model: ChargesModel, 
    ...
    nb_clients_total = client_model.compter_clients_par_salon(salon_id_admin)
    ...
    try:
        ...
        if salon_id and st.session_state.get('db_connection'):
            try:
                ...
                logger.warning("Erreur récupération logo pour PDF charges: %s", e)
        ...
        try:
            ...
            logger.warning("Erreur construction pied de page PDF charges: %s", e)
        ...
        if logo_img:
            try:
                ...
                logger.warning("Erreur ajout logo dans PDF charges: %s", e)
        ...
        def dessiner_footer(canvas_obj, doc_obj):
            ...
            try:
                ...
                logger.warning("Erreur dessin pied de page PDF charges: %s", e)
        ...
        logger.exception("Erreur génération PDF tableau charges")
        return None
