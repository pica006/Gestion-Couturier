...
class CommandeController:
    ...
    def sauvegarder_image(self, uploaded_file, commande_id: int, image_type: str) -> Optional[str]:
        ...
        """
        try:
            # Chemin temporaire (Render-safe) : évite les surprises sur FS éphémère.
            images_path = os.path.join(tempfile.gettempdir(), "couturier_images")
            ...
            logger.exception("Erreur sauvegarde image")
            return None
    ...
    def creer_commande(self, couturier_id: int, client_info: Dict,
        ...
        try:
            ...
            logger.exception("Erreur création commande")
            return False, None, "Erreur lors de la création de la commande"
    ...
    def calculer_somme_terminees(self, salon_id: Optional[str] = None, 
        ...
        try:
            ...
            logger.warning("Erreur calcul somme terminées: %s", e)
            return (0.0, 0)
    ...
    def calculer_somme_livrees(self, salon_id: Optional[str] = None,
        ...
        try:
            ...
            logger.warning("Erreur calcul somme livrées: %s", e)
            return (0.0, 0)