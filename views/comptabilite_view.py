...
def afficher_page_comptabilite():
    ...
    try:
        ...
        logger.exception("Impossible d'initialiser la comptabilité")
        st.error("❌ Impossible d'initialiser la comptabilité.")
        return
    ...
    try:
        ...
        logger.exception("Erreur lors du chargement des données comptables")
